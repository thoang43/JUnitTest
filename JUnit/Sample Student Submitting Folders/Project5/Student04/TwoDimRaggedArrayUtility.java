...
public class TwoDimRaggedArrayUtility 
{
	 ...
	 * Each row in the file is separated by a new line Each element in the row 
	 * is separated by a space Suggestion: You need to know how many rows and 
	 * how many columns there are for each row to create a ragged array. 
	 * 1. Read the doubles from the file into an a temporary array [10][10] 
	 * of Strings which was initialized to nulls. 
